...
description: 'Validate tasks.md integrity: IDs, ordering, evidence references, and
  simulation-vs-physical separation'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: kivori-gates:commands/speckit.kivori-gates.task-audit.md
---
