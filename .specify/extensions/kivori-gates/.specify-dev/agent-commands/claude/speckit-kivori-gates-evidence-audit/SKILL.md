...
description: Verify each checked task's evidence is sufficient and that simulation
  is never cited as physical proof
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: kivori-gates:commands/speckit.kivori-gates.evidence-audit.md
---
