...
the previous _startup_ blocker from automated acceptance, but it does not manufacture any of the manual
...
| 14  | Only semantic state is sent (verified via typed session activity, not payload bytes) | FR-015         |               |                                                                                                                                                                                                                      |
...
| 22  | No sensitive data appears in the typed session activity view or the log file while connected                                                | SC-010         |               |                                                                                                                                                                                                                        |
